...
if ($Y<>'') {
	...
	if (isset($_POST['Cari'])) {
	  ...
	  echo "<a href='invoice.php'><sup>X</sup></a></center></h3>";
		...
		$sql = "select*from invoice where Inv_No like'%$Y%' or Inv_Date like'%$Y%'";
...
<body>
	<br><br><br><br>
	<br><br><br><br>
<font color="black"><h1>SBasdatxxx.com</h1>
  <p>Selamat Datang didalam sistem <font color="blue"><?php   echo $_SESSION['Nama']; ?></font></p>
</html>
<?php    }
?>